...
pdf(paste0("./0102/tweets_text/wordcloud_",k,".pdf"))
for (i in 1:k){
...
write.csv(clustered_tweets_by_text, 
          file =paste0("./0102/tweets_text/clustered_tweets_text_k",k,".csv"), row.names = F)
...
write.csv(selected_tweets, 
           file =paste0("./0102/tweets_text/selected_tweets_text_k",k,".csv"),                          row.names = F)

# name the clusters
#8 -- Goofy Elizabeth Warren Our Native American Senator ,"failing @nytimes"
if(allTweets == TRUE){
labels_twitter_text <- c("voteTrump_primary", "debates","elizabethWarren",
                         "crooked_drainswamp","enjoyInterview",
                         "law_police_condolence",
                         "#amerifirst_#imwithyou", "trumprally_joinme",
                         "obamacare_urgevote", "trumprally_thankyou",
                         "specialInterests","MAGA_#primary",
                         "riggedSystem_email","tedcruz_rep",
                         "nytime_cnn","urgeDonation",
                         "clintion_sanders_obama",
                         "job_border",
                         "poll_debate_@megyn", "amazingcrowd" )
...
for each cluster of Trump followers,  what are the distributions of  
types they are retweet/replies to
